...
if (!class_exists('WC_VC_EU_Private')) {

    class WC_VC_EU_Private extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be unique.
        public $vc_aino_id = 'vconnect_postnord_dk_dpdeu';
        ...
        protected $vc_aino_title = 'European Delivery';

<?php
if (!class_exists('WC_VC_SE_Pickup')) {

    class WC_VC_SE_Pickup extends Vc_Aino_Shipping_Method {

        // Id for your shipping method. Should be uunique.
        public $vc_aino_id = 'vconnect_postnord_se_pickup';
        // Type of the widget section for method
        public $vc_aino_type = 'postOfficeDelivery';
        // Title shown in admin
        protected $vc_aino_method_title = 'Til udleveringssted SE';
        ...
        protected $vc_aino_title = 'Sweden pickup';           
